...
float ENAC5FS = 0.120 + EREST_ACT // 0.050
float EKC5FS = -0.03 + EREST_ACT // -0.100
float ECAC5FS = 0.195 + EREST_ACT // 0.125
float EARC5FS = 0.030 + EREST_ACT // -0.040
...
function make_NaF16
        ...
        call NaF16 TABCREATE X {tab_divs} {v_min} {v_max}
        v = {v_min}
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            alpha = inf / tau   
            beta = (1- inf)/tau
            setfield NaF16 X_A->table[{i}] {alpha}
            setfield NaF16 X_B->table[{i}] {alpha + beta}
            v = v + dv
        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
            
        setfield NaF16 X_A->calc_mode 1 X_B->calc_mode 1
                    
        // Y table for gate h
        float dv = ({v_max} - {v_min})/{tab_divs}
        call NaF16 TABCREATE Y {tab_divs} {v_min} {v_max}
        v = {v_min}
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            alpha = inf / tau   
            beta = (1- inf)/tau
            setfield NaF16 Y_A->table[{i}] {alpha}
            setfield NaF16 Y_B->table[{i}] {alpha + beta}
            v = v + dv
        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
        setfield NaF16 Y_A->calc_mode 1 Y_B->calc_mode 1
end
...
function make_KDR16
        ...
        // X table for gate m
        float dv = ({v_max} - {v_min})/{tab_divs}
        call KDR16 TABCREATE X {tab_divs} {v_min} {v_max}
        v = {v_min}
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            alpha = inf / tau   
            beta = (1- inf)/tau
            setfield KDR16 X_A->table[{i}] {alpha}
            setfield KDR16 X_B->table[{i}] {alpha + beta}
            v = v + dv
        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
            
        setfield KDR16 X_A->calc_mode 1 X_B->calc_mode 1
end
...
function make_K216
        ...
        // X table for gate m
        float dv = ({v_max} - {v_min})/{tab_divs}
        call K216 TABCREATE X {tab_divs} {v_min} {v_max}
        v = {v_min}
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            alpha = inf / tau   
            beta = (1- inf)/tau
            setfield K216 X_A->table[{i}] {alpha}
            setfield K216 X_B->table[{i}] {alpha + beta}
            v = v + dv
        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
            
        setfield K216 X_A->calc_mode 1 X_B->calc_mode 1
                    
        // Y table for gate h
        float dv = ({v_max} - {v_min})/{tab_divs}
        call K216 TABCREATE Y {tab_divs} {v_min} {v_max}
        v = {v_min}
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            alpha = inf / tau   
            beta = (1- inf)/tau
            setfield K216 Y_A->table[{i}] {alpha}
            setfield K216 Y_B->table[{i}] {alpha + beta}
            v = v + dv
        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
            
        setfield K216 Y_A->calc_mode 1 Y_B->calc_mode 1
end
...
function make_CaL16
        ...
        // X table for gate m 
        float dv = ({v_max} - {v_min})/{tab_divs}
        call CaL16 TABCREATE X {tab_divs} {v_min} {v_max}
        v = {v_min}
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            alpha = inf / tau   
            beta = (1- inf)/tau
            setfield CaL16 X_A->table[{i}] {alpha}
            setfield CaL16 X_B->table[{i}] {alpha + beta}
            v = v + dv

        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
            
        setfield CaL16 X_A->calc_mode 1 X_B->calc_mode 1
                    
        // Y table for gate h
        float dv = ({v_max} - {v_min})/{tab_divs}
        call CaL16 TABCREATE Y {tab_divs} {v_min} {v_max}
        v = {v_min}
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            alpha = inf / tau   
            beta = (1- inf)/tau
            setfield CaL16 Y_A->table[{i}] {alpha}
            setfield CaL16 Y_B->table[{i}] {alpha + beta}
            v = v + dv
        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
            
        setfield CaL16 Y_A->calc_mode 1 Y_B->calc_mode 1
end
...
function make_KCs16
        ...
        // X table for gate m
        float dv = ({v_max} - {v_min})/{tab_divs}
        call KCs16 TABCREATE X {tab_divs} {v_min} {v_max}
        ...
        setfield KCs16 X_A->calc_mode 1 X_B->calc_mode 1
        ...
        call KCs16 TABCREATE  Z {tab_divs} {conc_min} {conc_max}
        float const_state
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            setfield KCs16 Z_A->table[{i}] {0}
            setfield KCs16 Z_B->table[{i}] {const_state}
            ca_conc= ca_conc + dc
        end
        tweaktau KCs16 Z
