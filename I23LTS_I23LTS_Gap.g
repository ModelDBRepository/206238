...
for (i=0;i<=(I23LTS_NY-1);i=i+1)
    for (j=0;j<=(I23LTS_NX-1);j=j+1)
        ...
        //pk if ({dexE<I23LTS_NX} && {dexS>I23LTS_NY} && {randconn<{globalconnprob}})
...
//pk    if ({dexS==I23LTS_NY} && {randconn<{globalconnprob}} && {dexE==I23LTS_NX} && { {jnodedex} < {sqrtNnodes-1} }) //for nodal edge corner
        if ({dexS==I23LTS_NY} && {randconn<{globalconnprob}} && {dexE==I23LTS_NX} && { {jnodedex} < {sqrtNnodes-1} } && {{mynode} < {{sqrtNnodes}*{sqrtNnodes-1}}}) //for nodal edge corner
