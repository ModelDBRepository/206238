...
function make_NaF11
        ...
        call NaF11 TABCREATE X {tab_divs} {v_min} {v_max}
        ...
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            setfield NaF11 X_A->table[{i}] {alpha}
            setfield NaF11 X_B->table[{i}] {alpha + beta}
            v = v + dv

        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
            
        setfield NaF11 X_A->calc_mode 1 X_B->calc_mode 1
                    
        // Creating table for gate h, using name Y for it here

        float dv = ({v_max} - {v_min})/{tab_divs}
            
        call NaF11 TABCREATE Y {tab_divs} {v_min} {v_max}
        ...
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            setfield NaF11 Y_A->table[{i}] {alpha}
            setfield NaF11 Y_B->table[{i}] {alpha + beta}
            v = v + dv

        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
            
        setfield NaF11 Y_A->calc_mode 1 Y_B->calc_mode 1
...
function make_NaP11
        ...
        call NaP11 TABCREATE X {tab_divs} {v_min} {v_max}
        v = {v_min}
        ...
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            setfield NaP11 X_A->table[{i}] {alpha}
            setfield NaP11 X_B->table[{i}] {alpha + beta}
                
            v = v + dv
        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
        setfield NaP11 X_A->calc_mode 1 X_B->calc_mode 1
end
...
function make_KDR11
        ...
        call KDR11 TABCREATE X {tab_divs} {v_min} {v_max}
        ...
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            setfield KDR11 X_A->table[{i}] {alpha}
            setfield KDR11 X_B->table[{i}] {alpha + beta}
            v = v + dv

        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
            
        setfield KDR11 X_A->calc_mode 1 X_B->calc_mode 1
end
...
function make_KA11
        ...
        call KA11 TABCREATE X {tab_divs} {v_min} {v_max}
        ...
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            setfield KA11 X_A->table[{i}] {alpha}
            setfield KA11 X_B->table[{i}] {alpha + beta}
            v = v + dv

        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
            
        setfield KA11 X_A->calc_mode 1 X_B->calc_mode 1
                    
        // Y table for gate h

        float dv = ({v_max} - {v_min})/{tab_divs}
        call KA11 TABCREATE Y {tab_divs} {v_min} {v_max}
        ...
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            setfield KA11 Y_A->table[{i}] {alpha}
            setfield KA11 Y_B->table[{i}] {alpha + beta}

            v = v + dv

        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
            
        setfield KA11 Y_A->calc_mode 1 Y_B->calc_mode 1
end
...
function make_K211
        ...
        call K211 TABCREATE X {tab_divs} {v_min} {v_max}
        ...
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            setfield K211 X_A->table[{i}] {alpha}
            setfield K211 X_B->table[{i}] {alpha + beta}
                
            v = v + dv

        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
            
        setfield K211 X_A->calc_mode 1 X_B->calc_mode 1
                    
        // Y table for gate h
        float dv = ({v_max} - {v_min})/{tab_divs}
            
        call K211 TABCREATE Y {tab_divs} {v_min} {v_max}
        ...
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            setfield K211 Y_A->table[{i}] {alpha}
            setfield K211 Y_B->table[{i}] {alpha + beta}
                
            v = v + dv

        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
        setfield K211 Y_A->calc_mode 1 Y_B->calc_mode 1
end
...
function make_KM11
        ...
        call KM11 TABCREATE X {tab_divs} {v_min} {v_max}
        ...
        for (i = 0; i <= ({tab_divs}); i = i + 1)
           ...
           beta = 10 * {exp {(v +0.043) / -0.018}}
            ...
            setfield KM11 X_A->table[{i}] {alpha}
            setfield KM11 X_B->table[{i}] {alpha + beta}
            v = v + dv

        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
            
        setfield KM11 X_A->calc_mode 1 X_B->calc_mode 1
end
...
function make_CaL11
        ...
        call CaL11 TABCREATE X {tab_divs} {v_min} {v_max}
        ...
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            setfield CaL11 X_A->table[{i}] {alpha}
            setfield CaL11 X_B->table[{i}] {alpha + beta}
            v = v + dv

        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
            
        setfield CaL11 X_A->calc_mode 1 X_B->calc_mode 1
                    
        // Creating table for gate h, using name Y for it here

        float dv = ({v_max} - {v_min})/{tab_divs}
            
        call CaL11 TABCREATE Y {tab_divs} {v_min} {v_max}
        ...
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            setfield CaL11 Y_A->table[{i}] {alpha}
            setfield CaL11 Y_B->table[{i}] {alpha + beta}
            v = v + dv

        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
            
        setfield CaL11 Y_A->calc_mode 1 Y_B->calc_mode 1
end
...
function make_CaH11
        ...
        call CaH11 TABCREATE X {tab_divs} {v_min} {v_max}
        ...
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            setfield CaH11 X_A->table[{i}] {alpha}
            setfield CaH11 X_B->table[{i}] {alpha + beta}
            v = v + dv

        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
            
        setfield CaH11 X_A->calc_mode 1 X_B->calc_mode 1
...
function make_KCs11
        ...
        call KCs11 TABCREATE X {tab_divs} {v_min} {v_max}
        ...
        setfield KCs11 X_A->calc_mode 1 X_B->calc_mode 1
        ...
        call KCs11 TABCREATE  Z {tab_divs} {conc_min} {conc_max}
        float const_state
        ...
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            setfield KCs11 Z_A->table[{i}] {0}
            setfield KCs11 Z_B->table[{i}] {const_state}
...
function make_KCd11
        ...
        call KCd11 TABCREATE X {tab_divs} {v_min} {v_max}
        ...
        setfield KCd11 X_A->calc_mode 1 X_B->calc_mode 1
        ...
        call KCd11 TABCREATE  Z {tab_divs} {conc_min} {conc_max}
        ...
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            setfield KCd11 Z_A->table[{i}] {0}
            setfield KCd11 Z_B->table[{i}] {const_state}
...
function make_KAHPs11
        ...
        call KAHPs11 TABCREATE Z {tab_divs} {conc_min} {conc_max}
        ...
        for (c = 0; c <= ({tab_divs}); c = c + 1)
           ...
           // Equation depends on concentration, so converting that too... 
            ...
            setfield KAHPs11 Z_A->table[{c}] {alpha}
            setfield KAHPs11 Z_B->table[{c}] {alpha + beta}
                    ca_conc = ca_conc + dc
                
        end // end of for (c = 0; c <= ({tab_divs}); c = c + 1)
                
        setfield KAHPs11 Z_conc 1
        setfield KAHPs11 Z_A->calc_mode 1 Z_B->calc_mode 1
...
function make_KAHPd11
        ...
        call KAHPd11 TABCREATE Z {tab_divs} {conc_min} {conc_max}
        ...
        for (c = 0; c <= ({tab_divs}); c = c + 1)
           ...
           // Equation depends on concentration, so converting that too... 
            ...
            setfield KAHPd11 Z_A->table[{c}] {alpha}
            setfield KAHPd11 Z_B->table[{c}] {alpha + beta}
                    ca_conc = ca_conc + dc
                
        end // end of for (c = 0; c <= ({tab_divs}); c = c + 1)
                
        setfield KAHPd11 Z_conc 1
        setfield KAHPd11 Z_A->calc_mode 1 Z_B->calc_mode 1
