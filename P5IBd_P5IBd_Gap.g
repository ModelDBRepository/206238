...
//float	P5IBd_NX = 5 ;defined in netparams.g
//float	P5IBd_NY = 5 ;defined in netparams.g
...
for (i=0;i<=(P5IBd_NY-1);i=i+1)
    for (j=0;j<=(P5IBd_NX-1);j=j+1)
        ...
        if ({dexN==-1} && {randconn<{globalconnprob}} && { {mynode} >= {sqrtNnodes} }) //for nodal edge
            ...
            //pk raddmsg@{{mynode} - {sqrtNnodes}} /P5IBdnet/P5IBd[{conn2dex}]/{conn2loc} /P5IBdnet/P5IBd[{conn1dex}]/{conn1loc}@{{mynode} + {sqrtNnodes}} RAXIAL {Rgap} Vm
            raddmsg@{{mynode} - {sqrtNnodes}} /P5IBdnet/P5IBd[{conn2dex}]/{conn2loc} /P5IBdnet/P5IBd[{conn1dex}]/{conn1loc}@{mynode} RAXIAL {Rgap} Vm
        ...
        if ({dexN==-1} && {randconn<{globalconnprob}} && {dexE==P5IBd_NX} && { {mynode} >= {sqrtNnodes} } && {jnodedex} < {sqrtNnodes-1}) //for nodal edge corner
            ...
            //pk raddmsg@{{mynode} - {sqrtNnodes} + 1} /P5IBdnet/P5IBd[{conn2dex}]/{conn2loc} /P5IBdnet/P5IBd[{conn1dex}]/{conn1loc}@{{mynode} + {sqrtNnodes} - 1} RAXIAL {Rgap} Vm
            raddmsg@{{mynode} - {sqrtNnodes} + 1} /P5IBdnet/P5IBd[{conn2dex}]/{conn2loc} /P5IBdnet/P5IBd[{conn1dex}]/{conn1loc}@{mynode} RAXIAL {Rgap} Vm
        end
        ...
        if ( {dexE==P5IBd_NX} && {dexN>-1} && {randconn<{globalconnprob}} && { {jnodedex} < {sqrtNnodes-1} } ) //for nodal edge
            ...
            //pk raddmsg@{{mynode} + 1} /P5IBdnet/P5IBd[{conn2dex}]/{conn2loc} /P5IBdnet/P5IBd[{conn1dex}]/{conn1loc}@{{mynode} - 1} RAXIAL {Rgap} Vm
            raddmsg@{{mynode} + 1} /P5IBdnet/P5IBd[{conn2dex}]/{conn2loc} /P5IBdnet/P5IBd[{conn1dex}]/{conn1loc}@{mynode} RAXIAL {Rgap} Vm
        end
