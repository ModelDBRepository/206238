...
float ENAB23FS = 0.120 + EREST_ACT // 0.050
float EKB23FS = -0.03 + EREST_ACT // -0.100
float ECAB23FS = 0.195 + EREST_ACT // 0.125
float EARB23FS = 0.030 + EREST_ACT // -0.040
...
function make_NaF5
        ...
        call NaF5 TABCREATE X {tab_divs} {v_min} {v_max}
        v = {v_min}
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            alpha = inf / tau   
            beta = (1- inf)/tau
            setfield NaF5 X_A->table[{i}] {alpha}
            setfield NaF5 X_B->table[{i}] {alpha + beta}
            v = v + dv
        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
            
        setfield NaF5 X_A->calc_mode 1 X_B->calc_mode 1
                    
        // Y table for gate h
        float dv = ({v_max} - {v_min})/{tab_divs}
        call NaF5 TABCREATE Y {tab_divs} {v_min} {v_max}
        v = {v_min}
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            alpha = inf / tau   
            beta = (1- inf)/tau
            setfield NaF5 Y_A->table[{i}] {alpha}
            setfield NaF5 Y_B->table[{i}] {alpha + beta}
            v = v + dv
        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
        setfield NaF5 Y_A->calc_mode 1 Y_B->calc_mode 1
end
...
function make_NaP5
        ...
        // X table for gate m
        float dv = ({v_max} - {v_min})/{tab_divs}
        call NaP5 TABCREATE X {tab_divs} {v_min} {v_max}
        v = {v_min}
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            alpha = inf / tau   
            beta = (1- inf)/tau
            setfield NaP5 X_A->table[{i}] {alpha}
            setfield NaP5 X_B->table[{i}] {alpha + beta}
            v = v + dv
        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
        setfield NaP5 X_A->calc_mode 1 X_B->calc_mode 1
end
...
function make_AR5
        ...
        // X table for gate m
        float dv = ({v_max} - {v_min})/{tab_divs}
        call AR5 TABCREATE X {tab_divs} {v_min} {v_max}
        v = {v_min}
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            setfield AR5 X_A->table[{i}] {alpha}
            setfield AR5 X_B->table[{i}] {alpha + beta}
            v = v + dv
        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
            
        setfield AR5 X_A->calc_mode 1 X_B->calc_mode 1
end
...
function make_KDR5
        ...
        // X table for gate m
        float dv = ({v_max} - {v_min})/{tab_divs}
        call KDR5 TABCREATE X {tab_divs} {v_min} {v_max}
        v = {v_min}
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            alpha = inf / tau   
            beta = (1- inf)/tau
            setfield KDR5 X_A->table[{i}] {alpha}
            setfield KDR5 X_B->table[{i}] {alpha + beta}
            v = v + dv
        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
            
        setfield KDR5 X_A->calc_mode 1 X_B->calc_mode 1
end
...
function make_KA5
        ...
        // X table for gate m
        float dv = ({v_max} - {v_min})/{tab_divs}
        call KA5 TABCREATE X {tab_divs} {v_min} {v_max}
        v = {v_min}
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            alpha = inf / tau   
            beta = (1- inf)/tau
            setfield KA5 X_A->table[{i}] {alpha}
            setfield KA5 X_B->table[{i}] {alpha + beta}
            v = v + dv
        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
            
        setfield KA5 X_A->calc_mode 1 X_B->calc_mode 1
                    
        // Y table for gate h
        float dv = ({v_max} - {v_min})/{tab_divs}
        call KA5 TABCREATE Y {tab_divs} {v_min} {v_max}
        v = {v_min}
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            alpha = inf / tau   
            beta = (1- inf)/tau
            setfield KA5 Y_A->table[{i}] {alpha}
            setfield KA5 Y_B->table[{i}] {alpha + beta}
            v = v + dv
        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
            
        setfield KA5 Y_A->calc_mode 1 Y_B->calc_mode 1
end
...
function make_K25
        ...
        // X table for gate m
        float dv = ({v_max} - {v_min})/{tab_divs}
        call K25 TABCREATE X {tab_divs} {v_min} {v_max}
        v = {v_min}
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            alpha = inf / tau   
            beta = (1- inf)/tau
            setfield K25 X_A->table[{i}] {alpha}
            setfield K25 X_B->table[{i}] {alpha + beta}
            v = v + dv
        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
            
        setfield K25 X_A->calc_mode 1 X_B->calc_mode 1
                    
        // Y table for gate h
        float dv = ({v_max} - {v_min})/{tab_divs}
        call K25 TABCREATE Y {tab_divs} {v_min} {v_max}
        v = {v_min}
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            alpha = inf / tau   
            beta = (1- inf)/tau
            setfield K25 Y_A->table[{i}] {alpha}
            setfield K25 Y_B->table[{i}] {alpha + beta}
            v = v + dv
        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
            
        setfield K25 Y_A->calc_mode 1 Y_B->calc_mode 1
end
...
function make_KM5
        ...
        // X table for gate m
        float dv = ({v_max} - {v_min})/{tab_divs}
        call KM5 TABCREATE X {tab_divs} {v_min} {v_max}
        v = {v_min}
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            //  alpha
            float alpha
            ...
            setfield KM5 X_A->table[{i}] {alpha}
            setfield KM5 X_B->table[{i}] {alpha + beta}
            v = v + dv
        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
        setfield KM5 X_A->calc_mode 1 X_B->calc_mode 1
end
...
function make_CaL5
        ...
        // X table for gate m 
        float dv = ({v_max} - {v_min})/{tab_divs}
        call CaL5 TABCREATE X {tab_divs} {v_min} {v_max}
        v = {v_min}
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            alpha = inf / tau   
            beta = (1- inf)/tau
            setfield CaL5 X_A->table[{i}] {alpha}
            setfield CaL5 X_B->table[{i}] {alpha + beta}
            v = v + dv

        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
            
        setfield CaL5 X_A->calc_mode 1 X_B->calc_mode 1
                    
        // Y table for gate h
        float dv = ({v_max} - {v_min})/{tab_divs}
        call CaL5 TABCREATE Y {tab_divs} {v_min} {v_max}
        v = {v_min}
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            alpha = inf / tau   
            beta = (1- inf)/tau
            setfield CaL5 Y_A->table[{i}] {alpha}
            setfield CaL5 Y_B->table[{i}] {alpha + beta}
            v = v + dv
        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
            
        setfield CaL5 Y_A->calc_mode 1 Y_B->calc_mode 1
end
...
function make_CaH5
        ...
        // X table for gate m
        float dv = ({v_max} - {v_min})/{tab_divs}
        call CaH5 TABCREATE X {tab_divs} {v_min} {v_max}
        v = {v_min}
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            // alpha & beta 
            float tau = 1/(alpha + beta)
            setfield CaH5 X_A->table[{i}] {alpha}
            setfield CaH5 X_B->table[{i}] {alpha + beta}
            v = v + dv
        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
        setfield CaH5 X_A->calc_mode 1 X_B->calc_mode 1
end
...
function make_KCs5
        ...
        // X table for gate m
        float dv = ({v_max} - {v_min})/{tab_divs}
        call KCs5 TABCREATE X {tab_divs} {v_min} {v_max}
        ...
        setfield KCs5 X_A->calc_mode 1 X_B->calc_mode 1
        ...
        call KCs5 TABCREATE  Z {tab_divs} {conc_min} {conc_max}
        float const_state
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            setfield KCs5 Z_A->table[{i}] {0}
            setfield KCs5 Z_B->table[{i}] {const_state}
            ca_conc= ca_conc + dc
        end
        tweaktau KCs5 Z
...
function make_KCd5
        ...
        // X table for gate m
        float dv = ({v_max} - {v_min})/{tab_divs}
        call KCd5 TABCREATE X {tab_divs} {v_min} {v_max}
        v = {v_min}
        for (i = 0; i <= ({tab_divs}); i = i + 1)
        ...
        setfield KCd5 X_A->calc_mode 1 X_B->calc_mode 1
        ...
        float dc = ({conc_max} - {conc_min})/{tab_divs}
        float ca_conc = {conc_min}
        call KCd5 TABCREATE  Z {tab_divs} {conc_min} {conc_max}
        float const_state
        ...
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            setfield KCd5 Z_A->table[{i}] {0}
            setfield KCd5 Z_B->table[{i}] {const_state}
            ca_conc= ca_conc + dc
        end
        tweaktau KCd5 Z
...
function make_KAHPs5
        ...
        float dc = ({conc_max} - {conc_min})/{tab_divs}
        float ca_conc = {conc_min}
        call KAHPs5 TABCREATE Z {tab_divs} {conc_min} {conc_max}
        for (c = 0; c <= ({tab_divs}); c = c + 1)
            ...
            // alpha and beta 
            float tau = 1/(alpha + beta)
            setfield KAHPs5 Z_A->table[{c}] {alpha}
            setfield KAHPs5 Z_B->table[{c}] {alpha + beta}
                    ca_conc = ca_conc + dc
        end // end of for (c = 0; c <= ({tab_divs}); c = c + 1)
        setfield KAHPs5 Z_conc 1
        setfield KAHPs5 Z_A->calc_mode 1 Z_B->calc_mode 1
...
function make_KAHPd5
        ...
        float dc = ({conc_max} - {conc_min})/{tab_divs}
        float ca_conc = {conc_min}
        call KAHPd5 TABCREATE Z {tab_divs} {conc_min} {conc_max}
        for (c = 0; c <= ({tab_divs}); c = c + 1)
            ...
            setfield KAHPd5 Z_A->table[{c}] {alpha}
            setfield KAHPd5 Z_B->table[{c}] {alpha + beta}
                    ca_conc = ca_conc + dc
        end // end of for (c = 0; c <= ({tab_divs}); c = c + 1)
                
        setfield KAHPd5 Z_conc 1
        setfield KAHPd5 Z_A->calc_mode 1 Z_B->calc_mode 1
