...
function make_NaF1
        ...
        call NaF1 TABCREATE X {tab_divs} {v_min} {v_max}
        v = {v_min}
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            setfield NaF1 X_A->table[{i}] {alpha}
            setfield NaF1 X_B->table[{i}] {alpha + beta}
            v = v + dv

        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
            
        setfield NaF1 X_A->calc_mode 1 X_B->calc_mode 1
                    
        // Y table for gate h
        float dv = ({v_max} - {v_min})/{tab_divs}
        call NaF1 TABCREATE Y {tab_divs} {v_min} {v_max}
        v = {v_min}
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            setfield NaF1 Y_A->table[{i}] {alpha}
            setfield NaF1 Y_B->table[{i}] {alpha + beta}
            v = v + dv
        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
            
        setfield NaF1 Y_A->calc_mode 1 Y_B->calc_mode 1
end
...
function make_NaP1
        ...
        // X table for gate m
        float dv = ({v_max} - {v_min})/{tab_divs}
        call NaP1 TABCREATE X {tab_divs} {v_min} {v_max}
        v = {v_min}
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            alpha = inf / tau   
            beta = (1- inf)/tau
            setfield NaP1 X_A->table[{i}] {alpha}
            setfield NaP1 X_B->table[{i}] {alpha + beta}
            v = v + dv
        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
            
        setfield NaP1 X_A->calc_mode 1 X_B->calc_mode 1
end
...
function make_AR1
        ...
        // X table for gate m
        float dv = ({v_max} - {v_min})/{tab_divs}
        call AR1 TABCREATE X {tab_divs} {v_min} {v_max}
        v = {v_min}
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            setfield AR1 X_A->table[{i}] {alpha}
            setfield AR1 X_B->table[{i}] {alpha + beta}
            v = v + dv
        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
            
        setfield AR1 X_A->calc_mode 1 X_B->calc_mode 1
end
...
function make_KDR1
        ...
        // X table for gate m
        float dv = ({v_max} - {v_min})/{tab_divs}
        call KDR1 TABCREATE X {tab_divs} {v_min} {v_max}
        v = {v_min}
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            alpha = inf / tau   
            beta = (1- inf)/tau
            setfield KDR1 X_A->table[{i}] {alpha}
            setfield KDR1 X_B->table[{i}] {alpha + beta}
            v = v + dv
        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
            
        setfield KDR1 X_A->calc_mode 1 X_B->calc_mode 1
end
...
function make_KA1
        ...
        // X table for gate m
        float dv = ({v_max} - {v_min})/{tab_divs}
        call KA1 TABCREATE X {tab_divs} {v_min} {v_max}
        v = {v_min}
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            setfield KA1 X_A->table[{i}] {alpha}
            setfield KA1 X_B->table[{i}] {alpha + beta}
            v = v + dv
        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
        setfield KA1 X_A->calc_mode 1 X_B->calc_mode 1
                    
        // Y table for gate h
        float dv = ({v_max} - {v_min})/{tab_divs}
        call KA1 TABCREATE Y {tab_divs} {v_min} {v_max}
        v = {v_min}
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            alpha = inf / tau   
            beta = (1- inf)/tau
            setfield KA1 Y_A->table[{i}] {alpha}
            setfield KA1 Y_B->table[{i}] {alpha + beta}
            v = v + dv
        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
            
        setfield KA1 Y_A->calc_mode 1 Y_B->calc_mode 1
end
...
function make_K21
        ...
        // X table for gate m
        float dv = ({v_max} - {v_min})/{tab_divs}
        call K21 TABCREATE X {tab_divs} {v_min} {v_max}
        v = {v_min}
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            alpha = inf / tau   
            beta = (1- inf)/tau
            setfield K21 X_A->table[{i}] {alpha}
            setfield K21 X_B->table[{i}] {alpha + beta}
            v = v + dv
        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
            
        setfield K21 X_A->calc_mode 1 X_B->calc_mode 1
                    
        // Y table for gate h
        float dv = ({v_max} - {v_min})/{tab_divs}
        call K21 TABCREATE Y {tab_divs} {v_min} {v_max}
        v = {v_min}
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            alpha = inf / tau   
            beta = (1- inf)/tau
            setfield K21 Y_A->table[{i}] {alpha}
            setfield K21 Y_B->table[{i}] {alpha + beta}
            v = v + dv
        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
            
        setfield K21 Y_A->calc_mode 1 Y_B->calc_mode 1
end
...
function make_KM1
        ...
        // X table for gate m
        float dv = ({v_max} - {v_min})/{tab_divs}
        call KM1 TABCREATE X {tab_divs} {v_min} {v_max}
        v = {v_min}
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            setfield KM1 X_A->table[{i}] {alpha}
            setfield KM1 X_B->table[{i}] {alpha + beta}
            v = v + dv
        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
        setfield KM1 X_A->calc_mode 1 X_B->calc_mode 1
end
...
function make_CaL1
        ...
        // X table for gate m
        float dv = ({v_max} - {v_min})/{tab_divs}
        call CaL1 TABCREATE X {tab_divs} {v_min} {v_max}
        v = {v_min}
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            alpha = inf / tau   
            beta = (1- inf)/tau
            setfield CaL1 X_A->table[{i}] {alpha}
            setfield CaL1 X_B->table[{i}] {alpha + beta}
            v = v + dv
        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
            
        setfield CaL1 X_A->calc_mode 1 X_B->calc_mode 1
                    
        // Y table for gate h
        float dv = ({v_max} - {v_min})/{tab_divs}
        call CaL1 TABCREATE Y {tab_divs} {v_min} {v_max}
        v = {v_min}
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            alpha = inf / tau   
            beta = (1- inf)/tau
            setfield CaL1 Y_A->table[{i}] {alpha}
            setfield CaL1 Y_B->table[{i}] {alpha + beta}
            v = v + dv
        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
            
        setfield CaL1 Y_A->calc_mode 1 Y_B->calc_mode 1
end
...
function make_CaH1
        ...
        // X table for gate m
        float dv = ({v_max} - {v_min})/{tab_divs}
        call CaH1 TABCREATE X {tab_divs} {v_min} {v_max}
        v = {v_min}
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            //  alpha and beta 
            float tau = 1/(alpha + beta)
            setfield CaH1 X_A->table[{i}] {alpha}
            setfield CaH1 X_B->table[{i}] {alpha + beta}
            v = v + dv
        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
            
        setfield CaH1 X_A->calc_mode 1 X_B->calc_mode 1
end
...
function make_KCs1
        ...
        // X table for gate m
        float dv = ({v_max} - {v_min})/{tab_divs}
        call KCs1 TABCREATE X {tab_divs} {v_min} {v_max}
        v = {v_min}
        for (i = 0; i <= ({tab_divs}); i = i + 1)
        ...
        setfield KCs1 X_A->calc_mode 1 X_B->calc_mode 1
        ...
        call KCs1 TABCREATE  Z {tab_divs} {conc_min} {conc_max}
        float const_state
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            setfield KCs1 Z_A->table[{i}] {0}
            setfield KCs1 Z_B->table[{i}] {const_state}
            ca_conc= ca_conc + dc
        end
        tweaktau KCs1 Z
...
function make_KCd1
        ...
        // X table for gate m
        float dv = ({v_max} - {v_min})/{tab_divs}
        call KCd1 TABCREATE X {tab_divs} {v_min} {v_max}
        v = {v_min}
        for (i = 0; i <= ({tab_divs}); i = i + 1)
        ...
        setfield KCd1 X_A->calc_mode 1 X_B->calc_mode 1
        ...
        float dc = ({conc_max} - {conc_min})/{tab_divs}
        float ca_conc = {conc_min}
        call KCd1 TABCREATE  Z {tab_divs} {conc_min} {conc_max}
        float const_state
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ca_conc = ca_conc * 0.000001 // ca_conc to units of equation
            if (ca_conc < 0.00025 )
            ...
            setfield KCd1 Z_A->table[{i}] {0}
            setfield KCd1 Z_B->table[{i}] {const_state}
            ca_conc= ca_conc + dc
        end
        tweaktau KCd1 Z
...
function make_KAHPs1
        ...
        float dc = ({conc_max} - {conc_min})/{tab_divs}
        float ca_conc = {conc_min}
        call KAHPs1 TABCREATE Z {tab_divs} {conc_min} {conc_max}
        for (c = 0; c <= ({tab_divs}); c = c + 1)
            ...
            float tau = 1/(alpha + beta)
            setfield KAHPs1 Z_A->table[{c}] {alpha}
            setfield KAHPs1 Z_B->table[{c}] {alpha + beta}
                    ca_conc = ca_conc + dc
        end // end of for (c = 0; c <= ({tab_divs}); c = c + 1)
                
        setfield KAHPs1 Z_conc 1
        setfield KAHPs1 Z_A->calc_mode 1 Z_B->calc_mode 1
...
function make_KAHPd1
        ...
        float dc = ({conc_max} - {conc_min})/{tab_divs}
        float ca_conc = {conc_min}
        call KAHPd1 TABCREATE Z {tab_divs} {conc_min} {conc_max}
        for (c = 0; c <= ({tab_divs}); c = c + 1)
            ...
            setfield KAHPd1 Z_A->table[{c}] {alpha}
            setfield KAHPd1 Z_B->table[{c}] {alpha + beta}
                    ca_conc = ca_conc + dc
        end // end of for (c = 0; c <= ({tab_divs}); c = c + 1)
                
        setfield KAHPd1 Z_conc 1
        setfield KAHPd1 Z_A->calc_mode 1 Z_B->calc_mode 1
