...
for (i=0;i<=(P6RSa_NY-1);i=i+1)
    for (j=0;j<=(P6RSb_NX-1);j=j+1)
        ...
        if ({dexN==-1} && {randconn<{globalconnprob}} && { {mynode} >= {sqrtNnodes} }) //for nodal edge
            ...
            //pk raddmsg@{{mynode} - {sqrtNnodes}} /P6RSbnet/P6RSb[{conn2dex}]/{conn2loc} /P6RSanet/P6RSa[{conn1dex}]/{conn1loc}@{{mynode} + {sqrtNnodes}} RAXIAL {Rgap} Vm
            raddmsg@{{mynode} - {sqrtNnodes}} /P6RSbnet/P6RSb[{conn2dex}]/{conn2loc} /P6RSanet/P6RSa[{conn1dex}]/{conn1loc}@{mynode} RAXIAL {Rgap} Vm 
        ...
        if ({dexN==-1} && {randconn<{globalconnprob}} && {dexE==P6RSa_NX} && { {mynode} >= {sqrtNnodes} } && {jnodedex} < {sqrtNnodes-1}) //for nodal edge corner
            ...
            //pk raddmsg@{{mynode} - {sqrtNnodes} + 1} /P6RSbnet/P6RSb[{conn2dex}]/{conn2loc} /P6RSanet/P6RSa[{conn1dex}]/{conn1loc}@{{mynode} + {sqrtNnodes} - 1} RAXIAL {Rgap} Vm
            raddmsg@{{mynode} - {sqrtNnodes} + 1} /P6RSbnet/P6RSb[{conn2dex}]/{conn2loc} /P6RSanet/P6RSa[{conn1dex}]/{conn1loc}@{mynode} RAXIAL {Rgap} Vm
        end
        ...
        if ( {dexE==P6RSa_NX} && {dexN>-1} && {randconn<{globalconnprob}} && { {jnodedex} < {sqrtNnodes-1} } ) //for nodal edge
            ...
            //pk raddmsg@{{mynode} + 1} /P6RSbnet/P6RSb[{conn2dex}]/{conn2loc} /P6RSanet/P6RSa[{conn1dex}]/{conn1loc}@{{mynode} - 1} RAXIAL {Rgap} Vm
            raddmsg@{{mynode} + 1} /P6RSbnet/P6RSb[{conn2dex}]/{conn2loc} /P6RSanet/P6RSa[{conn1dex}]/{conn1loc}@{mynode} RAXIAL {Rgap} Vm
        end
