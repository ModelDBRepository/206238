...
//float	P23RSd_NX = 5 ;defined in netparams.g
//float	P23RSd_NY = 5 ;defined in netparams.g
...
for (i=0;i<=(P23RSd_NY-1);i=i+1)
    for (j=0;j<=(P23RSd_NX-1);j=j+1)
        ...
        if ({dexN==-1} && {randconn<{globalconnprob}} && { {mynode} >= {sqrtNnodes} }) //for nodal edge
            ...
            //pk raddmsg@{{mynode} - {sqrtNnodes}} /P23RSdnet/P23RSd[{conn2dex}]/{conn2loc} /P23RSdnet/P23RSd[{conn1dex}]/{conn1loc}@{{mynode} + {sqrtNnodes}} RAXIAL {Rgap} Vm
            raddmsg@{{mynode} - {sqrtNnodes}} /P23RSdnet/P23RSd[{conn2dex}]/{conn2loc} /P23RSdnet/P23RSd[{conn1dex}]/{conn1loc}@{mynode} RAXIAL {Rgap} Vm
        ...
        if ({dexN==-1} && {randconn<{globalconnprob}} && {dexE==P23RSd_NX} && { {mynode} >= {sqrtNnodes} } && {jnodedex} < {sqrtNnodes-1}) //for nodal edge corner
            ...
            //pk raddmsg@{{mynode} - {sqrtNnodes} + 1} /P23RSdnet/P23RSd[{conn2dex}]/{conn2loc} /P23RSdnet/P23RSd[{conn1dex}]/{conn1loc}@{{mynode} + {sqrtNnodes} - 1} RAXIAL {Rgap} Vm
            raddmsg@{{mynode} - {sqrtNnodes} + 1} /P23RSdnet/P23RSd[{conn2dex}]/{conn2loc} /P23RSdnet/P23RSd[{conn1dex}]/{conn1loc}@{mynode} RAXIAL {Rgap} Vm
        end
        ...
        if ( {dexE==P23RSd_NX} && {dexN>-1} && {randconn<{globalconnprob}} && { {jnodedex} < {sqrtNnodes-1} } ) //for nodal edge
            ...
            //pk raddmsg@{{mynode} + 1} /P23RSdnet/P23RSd[{conn2dex}]/{conn2loc} /P23RSdnet/P23RSd[{conn1dex}]/{conn1loc}@{{mynode} - 1} RAXIAL {Rgap} Vm
            raddmsg@{{mynode} + 1} /P23RSdnet/P23RSd[{conn2dex}]/{conn2loc} /P23RSdnet/P23RSd[{conn1dex}]/{conn1loc}@{mynode} RAXIAL {Rgap} Vm
        end
        ...
        //pk if ({dexE<P23RSd_NX} && {dexS>P23RSd_NY} && {randconn<{globalconnprob}})
...
//pk    if ({dexS==P23RSd_NY} && {randconn<{globalconnprob}} && {dexE==P23RSd_NX} && { {jnodedex} < {{sqrtNnodes}-1} } ) //for nodal edge corner
        if ({dexS==P23RSd_NY} && {randconn<{globalconnprob}} && {dexE==P23RSd_NX} && { {jnodedex} < {sqrtNnodes-1} } && {{mynode} < {{sqrtNnodes}*{sqrtNnodes-1}}}) //for nodal edge corner
       ...
       //pk if ({dexS==P23RSd_NY} && {randconn<{globalconnprob}} && { {mynode} >= {sqrtNnodes}*{sqrtNnodes-1} }) //for nodal edge
        ...
        if ({dexS==P23RSd_NY} && {randconn<{globalconnprob}} && {dexE==1} && { {jnodedex} > 0 } && { {mynode} < {{sqrtNnodes}*{sqrtNnodes-1}}}) //for nodal edge corner
