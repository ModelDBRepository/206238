...
for (i=0;i<=(P23RSc_NY-1);i=i+1)
    for (j=0;j<=(P23RSc_NX-1);j=j+1)
       ...
       //pk raddmsg@{{mynode} - {sqrtNnodes}} /P23FRBanet/P23FRBa[{conn2dex}]/{conn2loc} /P23RScnet/P23RSc[{conn1dex}]/{conn1loc}@{{mynode} + {sqrtNnodes}} RAXIAL {Rgap} Vm
            raddmsg@{{mynode} - {sqrtNnodes}} /P23FRBanet/P23FRBa[{conn2dex}]/{conn2loc} /P23RScnet/P23RSc[{conn1dex}]/{conn1loc}@{mynode} RAXIAL {Rgap} Vm
    ...
    //pk    raddmsg@{{mynode} - {sqrtNnodes} + 1} /P23FRBanet/P23FRBa[{conn2dex}]/{conn2loc} /P23RScnet/P23RSc[{conn1dex}]/{conn1loc}@{{mynode} + {sqrtNnodes} - 1} RAXIAL {Rgap} Vm
            raddmsg@{{mynode} - {sqrtNnodes} + 1} /P23FRBanet/P23FRBa[{conn2dex}]/{conn2loc} /P23RScnet/P23RSc[{conn1dex}]/{conn1loc}@{mynode} RAXIAL {Rgap} Vm
      ...
      //pk  raddmsg@{{mynode} + 1} /P23FRBanet/P23FRBa[{conn2dex}]/{conn2loc} /P23RScnet/P23RSc[{conn1dex}]/{conn1loc}@{{mynode} - 1} RAXIAL {Rgap} Vm
            raddmsg@{{mynode} + 1} /P23FRBanet/P23FRBa[{conn2dex}]/{conn2loc} /P23RScnet/P23RSc[{conn1dex}]/{conn1loc}@{mynode} RAXIAL {Rgap} Vm
        end
  ...
  //pk  if ({dexS >= P23RSc_NY-1} && {randconn < {globalconnprob}} && {dexE >= P23RSc_NX-1} && { {jnodedex} < {sqrtNnodes-1} }) //for nodal edge corner
        if ({dexS >= P23RSc_NY-1} && {randconn < {globalconnprob}} && {dexE >= P23RSc_NX-1} && { {jnodedex} < {sqrtNnodes-1} } && {{mynode} < {{sqrtNnodes}*{sqrtNnodes-1}}}) //for nodal edge corner
  ...
  //pk  if ({dexS >= P23RSc_NY-1} && {randconn < {globalconnprob}} && { {mynode} >= {sqrtNnodes}*{sqrtNnodes-1} }) //for nodal edge
   ...
   //pk if ({dexS >= P23RSc_NY-1} && {randconn < {globalconnprob}} && {dexE <= 2} && { {jnodedex} > 0 }) //for nodal edge corner
        if ({dexS >= P23RSc_NY-1} && {randconn < {globalconnprob}} && {dexE <= 2} && { {jnodedex} > 0 } && { {mynode} < {{sqrtNnodes}*{sqrtNnodes-1}}}) //for nodal edge corner
