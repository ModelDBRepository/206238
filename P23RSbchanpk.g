...
function make_NaF2
        ...
        call NaF2 TABCREATE X {tab_divs} {v_min} {v_max}
        v = {v_min}
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            setfield NaF2 X_A->table[{i}] {alpha}
            setfield NaF2 X_B->table[{i}] {alpha + beta}
            v = v + dv

        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
            
        setfield NaF2 X_A->calc_mode 1 X_B->calc_mode 1
                    
        // Y table for gate h
        float dv = ({v_max} - {v_min})/{tab_divs}
        call NaF2 TABCREATE Y {tab_divs} {v_min} {v_max}
        v = {v_min}
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            setfield NaF2 Y_A->table[{i}] {alpha}
            setfield NaF2 Y_B->table[{i}] {alpha + beta}
            v = v + dv
        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
            
        setfield NaF2 Y_A->calc_mode 1 Y_B->calc_mode 1
end
...
function make_NaP2
        ...
        // X table for gate m
        float dv = ({v_max} - {v_min})/{tab_divs}
        call NaP2 TABCREATE X {tab_divs} {v_min} {v_max}
        v = {v_min}
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            alpha = inf / tau   
            beta = (1- inf)/tau
            setfield NaP2 X_A->table[{i}] {alpha}
            setfield NaP2 X_B->table[{i}] {alpha + beta}
            v = v + dv
        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
            
        setfield NaP2 X_A->calc_mode 1 X_B->calc_mode 1
end
...
function make_AR2
        ...
        // X table for gate m
        float dv = ({v_max} - {v_min})/{tab_divs}
        call AR2 TABCREATE X {tab_divs} {v_min} {v_max}
        v = {v_min}
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            setfield AR2 X_A->table[{i}] {alpha}
            setfield AR2 X_B->table[{i}] {alpha + beta}
            v = v + dv
        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
            
        setfield AR2 X_A->calc_mode 1 X_B->calc_mode 1
end
...
function make_KDR2
        ...
        // X table for gate m
        float dv = ({v_max} - {v_min})/{tab_divs}
        call KDR2 TABCREATE X {tab_divs} {v_min} {v_max}
        v = {v_min}
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            alpha = inf / tau   
            beta = (1- inf)/tau
            setfield KDR2 X_A->table[{i}] {alpha}
            setfield KDR2 X_B->table[{i}] {alpha + beta}
            v = v + dv
        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
            
        setfield KDR2 X_A->calc_mode 1 X_B->calc_mode 1
end
...
function make_KA2
        ...
        // X table for gate m
        float dv = ({v_max} - {v_min})/{tab_divs}
        call KA2 TABCREATE X {tab_divs} {v_min} {v_max}
        v = {v_min}
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            setfield KA2 X_A->table[{i}] {alpha}
            setfield KA2 X_B->table[{i}] {alpha + beta}
            v = v + dv
        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
        setfield KA2 X_A->calc_mode 1 X_B->calc_mode 1
                    
        // Y table for gate h
        float dv = ({v_max} - {v_min})/{tab_divs}
        call KA2 TABCREATE Y {tab_divs} {v_min} {v_max}
        v = {v_min}
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            alpha = inf / tau   
            beta = (1- inf)/tau
            setfield KA2 Y_A->table[{i}] {alpha}
            setfield KA2 Y_B->table[{i}] {alpha + beta}
            v = v + dv
        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
            
        setfield KA2 Y_A->calc_mode 1 Y_B->calc_mode 1
end
...
function make_K22
        ...
        // X table for gate m
        float dv = ({v_max} - {v_min})/{tab_divs}
        call K22 TABCREATE X {tab_divs} {v_min} {v_max}
        v = {v_min}
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            alpha = inf / tau   
            beta = (1- inf)/tau
            setfield K22 X_A->table[{i}] {alpha}
            setfield K22 X_B->table[{i}] {alpha + beta}
            v = v + dv
        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
            
        setfield K22 X_A->calc_mode 1 X_B->calc_mode 1
                    
        // Y table for gate h
        float dv = ({v_max} - {v_min})/{tab_divs}
        call K22 TABCREATE Y {tab_divs} {v_min} {v_max}
        v = {v_min}
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            alpha = inf / tau   
            beta = (1- inf)/tau
            setfield K22 Y_A->table[{i}] {alpha}
            setfield K22 Y_B->table[{i}] {alpha + beta}
            v = v + dv
        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
            
        setfield K22 Y_A->calc_mode 1 Y_B->calc_mode 1
end
...
function make_KM2
        ...
        // X table for gate m
        float dv = ({v_max} - {v_min})/{tab_divs}
        call KM2 TABCREATE X {tab_divs} {v_min} {v_max}
        v = {v_min}
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            setfield KM2 X_A->table[{i}] {alpha}
            setfield KM2 X_B->table[{i}] {alpha + beta}
            v = v + dv
        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
        setfield KM2 X_A->calc_mode 1 X_B->calc_mode 1
end
...
function make_CaL2
        ...
        // X table for gate m
        float dv = ({v_max} - {v_min})/{tab_divs}
        call CaL2 TABCREATE X {tab_divs} {v_min} {v_max}
        v = {v_min}
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            alpha = inf / tau   
            beta = (1- inf)/tau
            setfield CaL2 X_A->table[{i}] {alpha}
            setfield CaL2 X_B->table[{i}] {alpha + beta}
            v = v + dv
        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
            
        setfield CaL2 X_A->calc_mode 1 X_B->calc_mode 1
                    
        // Y table for gate h
        float dv = ({v_max} - {v_min})/{tab_divs}
        call CaL2 TABCREATE Y {tab_divs} {v_min} {v_max}
        v = {v_min}
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            alpha = inf / tau   
            beta = (1- inf)/tau
            setfield CaL2 Y_A->table[{i}] {alpha}
            setfield CaL2 Y_B->table[{i}] {alpha + beta}
            v = v + dv
        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
            
        setfield CaL2 Y_A->calc_mode 1 Y_B->calc_mode 1
end
...
function make_CaH2
        ...
        // X table for gate m
        float dv = ({v_max} - {v_min})/{tab_divs}
        call CaH2 TABCREATE X {tab_divs} {v_min} {v_max}
        v = {v_min}
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            //  alpha and beta 
            float tau = 1/(alpha + beta)
            setfield CaH2 X_A->table[{i}] {alpha}
            setfield CaH2 X_B->table[{i}] {alpha + beta}
            v = v + dv
        end // end of for (i = 0; i <= ({tab_divs}); i = i + 1)
            
        setfield CaH2 X_A->calc_mode 1 X_B->calc_mode 1
end
...
function make_KCs2
        ...
        // X table for gate m
        float dv = ({v_max} - {v_min})/{tab_divs}
        call KCs2 TABCREATE X {tab_divs} {v_min} {v_max}
        v = {v_min}
        for (i = 0; i <= ({tab_divs}); i = i + 1)
        ...
        setfield KCs2 X_A->calc_mode 1 X_B->calc_mode 1
        ...
        call KCs2 TABCREATE  Z {tab_divs} {conc_min} {conc_max}
        float const_state
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ...
            setfield KCs2 Z_A->table[{i}] {0}
            setfield KCs2 Z_B->table[{i}] {const_state}
            ca_conc= ca_conc + dc
        end
        tweaktau KCs2 Z
...
function make_KCd2
        ...
        // X table for gate m
        float dv = ({v_max} - {v_min})/{tab_divs}
        call KCd2 TABCREATE X {tab_divs} {v_min} {v_max}
        v = {v_min}
        for (i = 0; i <= ({tab_divs}); i = i + 1)
        ...
        setfield KCd2 X_A->calc_mode 1 X_B->calc_mode 1
        ...
        float dc = ({conc_max} - {conc_min})/{tab_divs}
        float ca_conc = {conc_min}
        call KCd2 TABCREATE  Z {tab_divs} {conc_min} {conc_max}
        float const_state
        for (i = 0; i <= ({tab_divs}); i = i + 1)
            ca_conc = ca_conc * 0.000001 // ca_conc to units of equation
            if (ca_conc < 0.00025 )
            ...
            setfield KCd2 Z_A->table[{i}] {0}
            setfield KCd2 Z_B->table[{i}] {const_state}
            ca_conc= ca_conc + dc
        end
        tweaktau KCd2 Z
...
function make_KAHPs2
        ...
        float dc = ({conc_max} - {conc_min})/{tab_divs}
        float ca_conc = {conc_min}
        call KAHPs2 TABCREATE Z {tab_divs} {conc_min} {conc_max}
        for (c = 0; c <= ({tab_divs}); c = c + 1)
            ...
            float tau = 1/(alpha + beta)
            setfield KAHPs2 Z_A->table[{c}] {alpha}
            setfield KAHPs2 Z_B->table[{c}] {alpha + beta}
                    ca_conc = ca_conc + dc
        end // end of for (c = 0; c <= ({tab_divs}); c = c + 1)
                
        setfield KAHPs2 Z_conc 1
        setfield KAHPs2 Z_A->calc_mode 1 Z_B->calc_mode 1
...
function make_KAHPd2
        ...
        float dc = ({conc_max} - {conc_min})/{tab_divs}
        float ca_conc = {conc_min}
        call KAHPd2 TABCREATE Z {tab_divs} {conc_min} {conc_max}
        for (c = 0; c <= ({tab_divs}); c = c + 1)
            ...
            setfield KAHPd2 Z_A->table[{c}] {alpha}
            setfield KAHPd2 Z_B->table[{c}] {alpha + beta}
                    ca_conc = ca_conc + dc
        end // end of for (c = 0; c <= ({tab_divs}); c = c + 1)
                
        setfield KAHPd2 Z_conc 1
        setfield KAHPd2 Z_A->calc_mode 1 Z_B->calc_mode 1
