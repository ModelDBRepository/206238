...
for (i=0;i<=(I5LTS_NY-1);i=i+1)
    for (j=0;j<=(I5LTS_NX/2-1);j=j+1)
        ...
        if ({dexN==-1} && {randconn<{globalconnprob}} && { {mynode} >= {sqrtNnodes} }) //for nodal edge
            ...
            //pk raddmsg@{{mynode} - {sqrtNnodes}} /I5LTSnet/I5LTS[{conn2dex}]/{conn2loc} /I5LTSnet/I5LTS[{conn1dex}]/{conn1loc}@{{mynode} + {sqrtNnodes}} RAXIAL {Rgap} Vm
            raddmsg@{{mynode} - {sqrtNnodes}} /I5LTSnet/I5LTS[{conn2dex}]/{conn2loc} /I5LTSnet/I5LTS[{conn1dex}]/{conn1loc}@{mynode} RAXIAL {Rgap} Vm
        ...
        if ({dexN==-1} && {randconn<{globalconnprob}} && {dexE==I5LTS_NX/2} && { {mynode} >= {sqrtNnodes} } && {jnodedex} < {sqrtNnodes-1}) //for nodal edge corner
            ...
            //pk raddmsg@{{mynode} - {sqrtNnodes} + 1} /I5LTSnet/I5LTS[{conn2dex}]/{conn2loc} /I5LTSnet/I5LTS[{conn1dex}]/{conn1loc}@{{mynode} + {sqrtNnodes} - 1} RAXIAL {Rgap} Vm
            raddmsg@{{mynode} - {sqrtNnodes} + 1} /I5LTSnet/I5LTS[{conn2dex}]/{conn2loc} /I5LTSnet/I5LTS[{conn1dex}]/{conn1loc}@{mynode} RAXIAL {Rgap} Vm
        end
        ...
        if ( {dexE==I5LTS_NX/2} && {dexN>-1} && {randconn<{globalconnprob}} && { {jnodedex} < {sqrtNnodes-1} } ) //for nodal edge
            ...
            //pk raddmsg@{{mynode} + 1} /I5LTSnet/I5LTS[{conn2dex}]/{conn2loc} /I5LTSnet/I5LTS[{conn1dex}]/{conn1loc}@{{mynode} - 1} RAXIAL {Rgap} Vm
            raddmsg@{{mynode} + 1} /I5LTSnet/I5LTS[{conn2dex}]/{conn2loc} /I5LTSnet/I5LTS[{conn1dex}]/{conn1loc}@{mynode} RAXIAL {Rgap} Vm
        end
        ...
        //pk if ({dexE<I5LTS_NX/2} && {dexS>I5LTS_NY} && {randconn<{globalconnprob}})
...
//pk    if ({dexS==I5LTS_NY} && {randconn<{globalconnprob}} && {dexE==I5LTS_NX/2} && { {jnodedex} < {sqrtNnodes-1} }) //for nodal edge corner
        if ({dexS==I5LTS_NY} && {randconn<{globalconnprob}} && {dexE==I5LTS_NX/2} && { {jnodedex} < {sqrtNnodes-1} } && {{mynode} < {{sqrtNnodes}*{sqrtNnodes-1}}}) //for nodal edge corner
        ...
        //pk if ({dexS==I5LTS_NY} && {randconn<{globalconnprob}} && { {mynode} >= {sqrtNnodes}*{sqrtNnodes-1} }) //for nodal edge
        ...
        //pk if ({dexS==I5LTS_NY} && {randconn<{globalconnprob}} && {dexE==1} && { {jnodedex} > 0 }) //for nodal edge corner
        if ({dexS==I5LTS_NY} && {randconn<{globalconnprob}} && {dexE==1} && { {jnodedex} > 0 } && { {mynode} < {{sqrtNnodes}*{sqrtNnodes-1}}}) //for nodal edge corner
