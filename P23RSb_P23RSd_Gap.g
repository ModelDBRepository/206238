...
for (i=0;i<=(P23RSb_NY-1);i=i+1)
    for (j=0;j<=(P23RSb_NX-1);j=j+1)
        ...
        if ({dexN==-1} && {randconn<{globalconnprob}} && { {mynode} >= {sqrtNnodes} }) //for nodal edge
            ...
            //pk raddmsg@{{mynode} - {sqrtNnodes}} /P23RSdnet/P23RSd[{conn2dex}]/{conn2loc} /P23RSbnet/P23RSb[{conn1dex}]/{conn1loc}@{{mynode} + {sqrtNnodes}} RAXIAL {Rgap} Vm
            raddmsg@{{mynode} - {sqrtNnodes}} /P23RSdnet/P23RSd[{conn2dex}]/{conn2loc} /P23RSbnet/P23RSb[{conn1dex}]/{conn1loc}@{mynode} RAXIAL {Rgap} Vm 
        ...
        if ({dexN==-1} && {randconn<{globalconnprob}} && {dexE==P23RSb_NX} && { {mynode} >= {sqrtNnodes} } && {jnodedex} < {sqrtNnodes-1}) //for nodal edge corner
            ...
            //pk raddmsg@{{mynode} - {sqrtNnodes} + 1} /P23RSdnet/P23RSd[{conn2dex}]/{conn2loc} /P23RSbnet/P23RSb[{conn1dex}]/{conn1loc}@{{mynode} + {sqrtNnodes} - 1} RAXIAL {Rgap} Vm
            raddmsg@{{mynode} - {sqrtNnodes} + 1} /P23RSdnet/P23RSd[{conn2dex}]/{conn2loc} /P23RSbnet/P23RSb[{conn1dex}]/{conn1loc}@{mynode} RAXIAL {Rgap} Vm
        end
        ...
        if ( {dexE==P23RSb_NX} && {dexN>-1} && {randconn<{globalconnprob}} && { {jnodedex} < {sqrtNnodes-1} } ) //for nodal edge
            ...
            //pk raddmsg@{{mynode} + 1} /P23RSdnet/P23RSd[{conn2dex}]/{conn2loc} /P23RSbnet/P23RSb[{conn1dex}]/{conn1loc}@{{mynode} - 1} RAXIAL {Rgap} Vm
            raddmsg@{{mynode} + 1} /P23RSdnet/P23RSd[{conn2dex}]/{conn2loc} /P23RSbnet/P23RSb[{conn1dex}]/{conn1loc}@{mynode} RAXIAL {Rgap} Vm
        end
